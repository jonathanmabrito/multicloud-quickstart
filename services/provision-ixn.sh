...
IXN_DB_PASSWORD=$(gcloud secrets versions access 1 --secret="IXN_ixn_db_password")
sed -i "s|INSERT_IXN_DB_PASSWORD|$IXN_DB_PASSWORD|g" "./services/$SERVICE/$SERVICE-k8secrets-deployment-secrets.yaml"
