...
TENANTCLIENTSECRET=$(gcloud secrets versions access 1 --secret="VOICE_tenant_gauth_client_secret")
sed -i "s|INSERT_TENANT_CLIENT_SECRET|$TENANTCLIENTSECRET|g" "./services/$SERVICE/$SERVICE-k8secrets-deployment-secrets.yaml"

TENANTPGDBPASSWORD=$(gcloud secrets versions access 1 --secret="VOICE_tenant_t100_pg_db_password")
sed -i "s|INSERT_TENANT_PG_DB_PASSWORD|$TENANTPGDBPASSWORD|g" "./services/$SERVICE/$SERVICE-k8secrets-deployment-secrets.yaml"
